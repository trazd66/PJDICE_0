...
namespace Callback
{	
	public delegate void eventVoidHandler(GameReference targetEvent);
	public delegate bool eventBoolHandler(GameReference targetEvent);
}

public abstract class CbHandler{
	private int _identifier;

	private GameReference targetEvent;
	...
	protected GameReference getTargetEvent(){
